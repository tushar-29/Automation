...
x_loc = data_element["x_cod"] + data_element['width'] / 2
y_loc = data_element["y_cod"] + data_element['height'] / 2
action.move_by_offset(data_element["x_cod"], data_element["y_cod"]).click()
